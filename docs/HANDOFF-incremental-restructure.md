...
- BrainStrom 分四阶段：阶段一「能写」(Step 0–2，已做骨架)、**阶段二「变聪明」(Step 3–7)**、阶段三「结构大修」（三分页 + AI 守门员，新插入，纯文档规划中）、阶段四「上线前开发」（原「能上架」改名往后移，Step 8–9：媒体/付费/社群/真登入/私密上架）。详见 `docs/阶段三-结构大修-开发文档.md`。
